    ...
    >
      ...
      <div className="w-full md:w-[20%]">
        <ul className="flex items-center flex-row md:justify-between md:gap-6 gap-0 w-full divide-x md:divide-x-0">
          <li className="px-2 flex justify-center py-4 md:px-0 md:bg-transparent md:py-0 w-[100%] bg-blue-100">
            <a
          ...
          <li className="px-2 flex justify-center py-4 md:px-0 md:bg-transparent md:py-0 w-[100%] bg-purple-200">
            <a
          ...
          <li className="px-2 flex justify-center py-4 md:px-0 md:bg-transparent md:py-0 w-[100%] bg-blue-200">
            <a
